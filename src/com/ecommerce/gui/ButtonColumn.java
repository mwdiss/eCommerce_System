...
/** A reusable button component for cells in a JTable. */
public class ButtonColumn extends AbstractCellEditor implements TableCellRenderer, TableCellEditor, ActionListener {
    ...
    @Override public Component getTableCellEditorComponent(JTable t, Object v, boolean s, int r, int c) { button.setText(""+v); this.row = r; return button; }
